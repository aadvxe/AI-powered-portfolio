...
export function PortfolioDetails({ onClose }: { onClose: () => void }) {
    const stack = [
        { name: "Framework", val: "Next.js 16 (React 19)" },
        { name: "Styling", val: "Tailwind CSS + Framer Motion" },
        { name: "Language", val: "TypeScript" },
        { name: "Database", val: "PostgreSQL + pgvector" },
        { name: "AI Model", val: "Gemini 3.1 Flash Lite" },
        { name: "Embeddings", val: "Gemini Embedding 001" },
    ];
